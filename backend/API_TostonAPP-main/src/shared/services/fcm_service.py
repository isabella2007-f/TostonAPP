...
_LABELS_ESTADO_CLIENTE = {
    ...
    11: ("Tu pedido ya está listo 🛍️",      "Listo 🛍️"),
    13: ("Ya lo estamos preparando 👩‍🍳", "En preparación 👩‍🍳"),
    16: ("Te proponemos otra fecha de entrega 📅", "Fecha propuesta 📅"),
    17: ("Vamos a proponerte otra fecha 📅",  "Esperando nueva fecha 📅"),
    18: ("Te entregamos una parte de tu pedido 📦", "Entregado en parte"),
    19: ("Lo estamos revisando: te vamos a llamar 📞", "Lo estamos revisando"),
    20: ("Falta tu pago para seguir 💳",      "Esperando tu pago 💳"),
    21: ("Nos falta tu confirmación de fecha 📅", "Fecha propuesta final 📅"),
    22: ("Tu pedido te espera en la tienda 🏪", "Retenido en tienda 🏪"),
    23: ("Tu pedido vuelve a la tienda 🚚", "En ruta de retorno 🚚"),
}
